...
import com.webWeavers.weaveGlow.biz.login.KakaoService;
...
public class KakaoLoginPageController {
	...
	@GetMapping("/callback")
	public String kakaoLogin(@RequestParam(name = "code") String code, MemberDTO memberDTO, Model model,
		...
		// profile 안에 있는 이메일 값을 문자열 형태로 저장

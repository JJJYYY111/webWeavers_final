...
public class MemberDAO {
	...
	// 회원 로그인
	private static final String SELECTONE_LOGIN = "SELECT MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_BIRTH, MEMBER_PHONE, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_MARKETING, GRADE_PK "
			+ "	FROM MEMBER WHERE MEMBER_ID=? AND MEMBER_PASSWORD=?";
	// 회원 닉네임 중복체크
	private static final String SELECTONE_MEMBER_NICKNAMECHECK = "SELECT MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_BIRTH, MEMBER_PHONE, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_MARKETING, GRADE_PK "
	...
	// 회원 정보수정(관리자)
	private static final String UPDATE_ADMIN = "UPDATE MEMBER SET MEMBER_PASSWORD=?, MEMBER_NAME=?, MEMBER_BIRTH=?, MEMBER_PHONE=?, MEMBER_NICKNAME=?, MEMBER_EMAIL=?, GRADE_PK=? WHERE MEMBER_ID=?";
	// 회원 휴면상태(탈퇴)						

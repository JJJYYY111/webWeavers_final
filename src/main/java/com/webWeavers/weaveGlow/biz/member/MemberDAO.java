...
public class MemberDAO {
	...
	private static final String SELECTONE_LOGIN = "SELECT MEMBER_ID, MEMBER_PASSWORD, MEMBER_MEMBER_NAME, MEMBER_MEMBER_BIRTH, MEMBER_MEMBER_PHONE, MEMBER_MEMBER_NICKNAME, MEMBER_MEMBER_EMAIL, MEMBER_MEMBER_MARKETING, GRADE_PK "
			+ "	FROM MEMBER WHERE MEMBER_ID=? AND MEMBER_PASSWORD=?";
	private static final String SELECTONE_MEMBER_NICKNAMECHECK = "SELECT MEMBER_ID, MEMBER_PASSWORD, MEMBER_MEMBER_NAME, MEMBER_MEMBER_BIRTH, MEMBER_MEMBER_PHONE, MEMBER_MEMBER_NICKNAME, MEMBER_MEMBER_EMAIL, MEMBER_MEMBER_MARKETING, GRADE_PK "
			+ "   FROM MEMBER WHERE MEMBER_NICKNAME=?";
	private static final String SELECTONE_MEMBERINFO = "SELECT M.MEMBER_ID, M.MEMBER_PASSWORD, M.MEMBER_MEMBER_NAME, M.MEMBER_MEMBER_BIRTH, M.MEMBER_MEMBER_PHONE, M.MEMBER_MEMBER_NICKNAME, M.MEMBER_MEMBER_EMAIL, M.MEMBER_MEMBER_MARKETING, M.GRADE_PK, G.GRADE_PK"
			+ "  FROM MEMBER M JOIN GRADE G " + "   ON (M.GRADE_PK = G.GRADE_PK) WHERE M.MEMBER_ID=?";
	private static final String SELECTONE_IDCHECK = "SELECT MEMBER_ID, MEMBER_PASSWORD, MEMBER_MEMBER_NAME, MEMBER_MEMBER_BIRTH, MEMBER_MEMBER_PHONE, MEMBER_MEMBER_NICKNAME, MEMBER_MEMBER_EMAIL, MEMBER_MEMBER_MARKETING, GRADE_PK "
			+ "   FROM MEMBER WHERE MEMBER_ID=?";

	private static final String INSERT = "INSERT INTO MEMBER (MEMBER_ID, MEMBER_PASSWORD, MEMBER_MEMBER_NAME, MEMBER_MEMBER_BIRTH, MEMBER_MEMBER_PHONE, MEMBER_MEMBER_NICKNAME, MEMBER_MEMBER_EMAIL, MEMBER_MEMBER_MARKETING) VALUES (?,?,?,?,?,?,?,?)";

	private static final String UPDATE = "UPDATE MEMBER SET MEMBER_MEMBER_EMAIL=?, MEMBER_MEMBER_NICKNAME=?, MEMBER_MEMBER_PHONE=?, MEMBER_PASSWORD=? WHERE MEMBER_ID=?";

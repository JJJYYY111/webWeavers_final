            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body" style="margin: 0 auto; width: 1000px; padding: 100px;">
                        ...
                        <h7 style="display: inline-block; margin-bottom: 30px;"> 회원정보에 등록한 정보와 입력한 정보가 같아야, 회원님의 아이디가 전송됩니다.</h7>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="home-b2">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" class="form-control col-md-4" id="memberName-01" name="memberName"
                                        placeholder="이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '이름'"/>
                                ...
                                <div class="col-md-12 form-group" style="margin-top: 50px;">
                                    ...
                                    <button id="findPwPhoneBtn" class="btn btn-outline-secondary waves-effect waves-light" type="button" onclick="sendPhoneID()">보내기</button>
                                </div>  
                            </div>
                            <div class="tab-pane" id="profile-b2">
                                <div class="col-md-12 form-group">
                                    <div class="col-md-4 label-text">이름</div>
                                    <input type="text" class="form-control col-md-4" id="memberName-02" name="memberName"
                                        placeholder="이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '이름'"/>
                                    <div class="col-md-4 label-text"></div>
                                </div>
                                <div class="col-md-12 form-group">
                                ...
                                <div class="col-md-12 form-group" style="margin-top: 50px;">
                                    <div class="col-md-5 label-text"></div>
                                    <button id="findPwEmailBtn" class="btn btn-outline-secondary waves-effect waves-light" type="button" onclick="sendEmailID()">보내기</button>
                                    </button>
                                </div>  
                            </div>
                        </div>

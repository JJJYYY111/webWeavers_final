            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">연간 매출 현황</h4>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-inline text-right">
                                    <li class="list-inline-item">
                                        <h5><i class="fa fa-circle mr-1 text-info"></i>작년</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5><i class="fa fa-circle mr-1 text-cyan"></i>올해</h5>
                                    </li>
                                </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <p class="text-center">작년</p>
                                    </div>
                
                                    <!-- Donut Chart 2 -->
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div id="morris-donut-chart2"></div>
                                        <p class="text-center">올해</p>
                                    </div>
                                </div>
                            </div>
                        </div>
